...
urlpatterns = [
    ...
    path("products/cart/add/<slug>/<int:id>/<int:quantity>/", AddToCartView.as_view(), name='add_to_cart_view'),
    path("products/cart/delete_one_cart_item/<slug>/<str:item_id>/<int:quantity>/", DeleteOneCartItemView.as_view(), name='delete_one_cart_item_view'),
